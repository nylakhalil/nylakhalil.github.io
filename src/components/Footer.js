        ...
        return (
            <footer id="footer" className="d-flex justify-content-between pl-4 pr-4 pt-2">
                <ul className="list-unstyled list-inline mb-1">
                    ...
                    <li className="list-inline-item footer-icons" title="LinkedIn Profile" onClick={() => this.handleClick("LinkedIn")}>
                        <a href="https://www.linkedin.com/in/nylakhalil/">
                            <FontAwesomeIcon icon={faLinkedin} color="Black" />
                        </a>
                    </li>
                    <li className="list-inline-item footer-icons" title="GitHub Profile" onClick={() => this.handleClick("GitHub")}>
