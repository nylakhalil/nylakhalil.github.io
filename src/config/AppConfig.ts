...
export const JSON_ENDPOINT = process.env.JSON_ENDPOINT || "/json";
export const MAP_JSON_ENDPOINT =
  process.env.REACT_APP_MAP_JSON || "/json/map.json";
export const DEVELOP_JSON_ENDPOINT =
